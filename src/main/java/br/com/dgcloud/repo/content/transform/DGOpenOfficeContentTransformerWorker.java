package br.com.dgcloud.repo.content.transform;
 ...
 * @author Derek Hulley
 */
public class DGOpenOfficeContentTransformerWorker extends DGOOoContentTransformerHelper implements ContentTransformerWorker, InitializingBean
{
    private static Log logger = LogFactory.getLog(DGOpenOfficeContentTransformerWorker.class);
